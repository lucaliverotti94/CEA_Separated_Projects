...
1.3 & 2026-03-22 & Team progetto & Introduzione vincolo hard \texttt{yield\_cap\_annual\_kg} in optimizer/realtime, planner default a 80 kg/anno, integrazione modulo economico locale \texttt{Analisi economica/cea\_economic\_analysis.py}. \\
...
\texttt{veg\_days} & 20 & 34 & giorni & mantenuto per retrocompatibilita BO \\
\texttt{flower\_total\_days} & 58 & 78 & giorni & mantenuto per retrocompatibilita BO \\
\texttt{flower\_early\_days} & 24 & 44 & giorni & mantenuto per retrocompatibilita BO \\
\bottomrule
\end{longtable}
...
\texttt{test\_economic\_hybrid\_model.py} & Verifica modulo economico locale \texttt{regular\_clone/Analisi economica/cea\_economic\_analysis.py}. \\
\bottomrule
\end{longtable}
...
Blocco economico & \texttt{Analisi economica/cea\_economic\_analysis.py} & Cap. 2, 11, 15 \\
